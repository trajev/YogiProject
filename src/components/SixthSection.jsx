...
const SixthSection = () => (
  <>
    <div className="SixthSection relative mt-36 md:mt-28 my-20 md:my-32  justify-center flex flex-col">
      ...
      <div className='mx-auto mt-40 md:mt-20 px-4'>
        <div className=' mb-2 w-5 md:w-auto left-[10vw] md:left-[24vw] top-[0vh] md:top-[29vh] flex gap-1 md:gap-2'>
          <img src="./images/Opening.png" alt="" />
          <img src="./images/Opening.png" alt="" />
        </div>
        <p className='font-Sora text-[18px] md:text-[30px] px-4 max-w-3xl text-center'>Working with Wix freaks law firm was a game-changer for me. Their team handled my <br /> wrongful termination case .I highly recommend their services to anyone in need of exceptional legal representation</p>
        <div className=' absolute flex w-5 md:w-auto right-[12vw] md:right-[28vw] bottom-[-3vh] md:bottom-[-4vh] max-w-[57vw] gap-1 md:gap-2'>
